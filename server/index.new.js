...
async function main() {
    ...
    // AUTH
    app.post(`${API_PREFIX}/auth/register`, asyncHandler(async (req, res) => {
    ...
    // USERS
    app.get(`${API_PREFIX}/users/me`, authRequired, asyncHandler(async (req, res) => {
    ...
    app.get(`${API_PREFIX}/users`, authRequired, requireRoles("Admin"), asyncHandler(async (_req, res) => {
    ...
    app.put(`${API_PREFIX}/users/:id`, authRequired, requireRoles("Admin"), asyncHandler(async (req, res) => {
    ...
    // COMPANIES
    app.get(`${API_PREFIX}/companies`, asyncHandler(async (_req, res) => {
        const rows = await dbAll(db, `SELECT companyID, name, industry, location FROM companies ORDER BY name ASC`);
        return res.json(rows);
    }));

    app.post(`${API_PREFIX}/companies`, authRequired, asyncHandler(async (req, res) => {
    ...
    // CATEGORIES
    app.get(`${API_PREFIX}/categories`, authOptional, asyncHandler(async (_req, res) => {
        const rows = await dbAll(
            db,
    ...
    app.post(`${API_PREFIX}/categories`, authRequired, requireRoles("Admin", "Management"), asyncHandler(async (req, res) => {
    ...
    app.put(`${API_PREFIX}/categories/:id`, authRequired, requireRoles("Admin", "Management"), asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
    ...
    app.delete(`${API_PREFIX}/categories/:id`, authRequired, requireRoles("Admin", "Management"), asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
        const existing = await dbGet(db, `SELECT categoryID FROM categories WHERE categoryID = ?`, [id]);
        if (!existing) return res.status(404).json({ error: "Not found" });
    ...
    // APPLICATIONS
    app.get(`${API_PREFIX}/applications`, authOptional, asyncHandler(async (req, res) => {
    ...
    app.post(`${API_PREFIX}/applications`, authRequired, requireAnyType("JobSeeker"), asyncHandler(async (req, res) => {
    ...
    app.put(`${API_PREFIX}/applications/:id`, authRequired, requireAnyType("JobSeeker"), asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
    ...
    app.delete(`${API_PREFIX}/applications/:id`, authRequired, requireAnyType("JobSeeker"), asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
        const existing = await dbGet(db, `SELECT * FROM applications WHERE appID = ?`, [id]);
        if (!existing) return res.status(404).json({ error: "Not found" });
    ...
    app.get(`${API_PREFIX}/applications/export.csv`, authRequired, asyncHandler(async (req, res) => {
        const user = req.user;
        const global = req.query.global === "1" || req.query.global === "true";
        const canSeeAll =
            hasRole(user, ["Admin", "Management"]) || (user.role === "Regular" && hasType(user, ["Analyst"]));
    ...
    // HISTORY
    app.get(`${API_PREFIX}/applications/:id/history`, authRequired, asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
    ...
    app.post(`${API_PREFIX}/applications/:id/history`, authRequired, asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
        const appRow = await dbGet(db, `SELECT userID FROM applications WHERE appID = ?`, [id]);
        if (!appRow) return res.status(404).json({ error: "Not found" });
    ...
    // REMINDERS
    app.get(`${API_PREFIX}/reminders`, authRequired, asyncHandler(async (req, res) => {
        const rows = await dbAll(
            db,
    ...
    app.post(`${API_PREFIX}/reminders`, authRequired, asyncHandler(async (req, res) => {
    ...
    app.delete(`${API_PREFIX}/reminders/:id`, authRequired, asyncHandler(async (req, res) => {
        const id = toInt(req.params.id);
    ...
    // DASHBOARD
    app.get(`${API_PREFIX}/dashboard`, asyncHandler(async (req, res) => {
    ...
    app.get(`${API_PREFIX}/dashboard/status-breakdown`, asyncHandler(async (req, res) => {
        // Guest preview
        if (!req.user) {
            return res.json([
    ...
    app.get(`${API_PREFIX}/dashboard/timeseries`, asyncHandler(async (req, res) => {
    ...
    if (clientDist) {
        ...
        app.get("*", (req, res) => {
            ...
            return res.status(404).send("API server online. Frontend not found.");
        });
    }
